;(function($, d3) {
    var D3Map = function(options) {
        var defaults = {
            ...
            mapHeight: 700,
            cityColor: "#429dd4",
            provinceColor: "#778899",
            mouseOverColor: "#9370DB",
    ...
    D3Map.prototype._init = function(options) {
        ...
        $(selector).on("GEOJSON_DONE", function(event, json) {
            ...
            .on("mousemove", function(data) {
                ...
                $('.mapTip').html(data.properties.name + "\r人数: ");
            ...
            .on("click", function(data) {
                if (data.properties.name == "江苏"){
                    window.location = "https://www.google.com/#newwindow=1&q=jiangsu";
                }
            });
        });
